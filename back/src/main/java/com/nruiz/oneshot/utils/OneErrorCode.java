...
public class OneErrorCode {
    ...
    public static final String ADMINISTRATOR_MESSAGE_CONTACT_FRENCH = "Une erreur est survenue, veuillez contacter l'administrateur en lui donnant le code erreur suivant: ";
    ...
    public static final String ERROR_MESSAGE_EMPTY_CART_FRENCH = "Le panier est vide";
    public static final String ERROR_MESSAGE_DELIVERY_MISSING_FRENCH = "L'adresse de livraison est manquante";
    public static final String ERROR_MESSAGE_FACTURATION_MISSING_FRENCH = "L'adresse de facturation est manquante";
